...
namespace Instagramclone {
	...
	public:
		...
		Search(UserGraph* graph, User* user)
		{
			...
			userCardsPanel->Location = System::Drawing::Point(10, 120); 			userCardsPanel->Size = System::Drawing::Size(1000, 400); 			this->Controls->Add(userCardsPanel); 		}
...
#pragma region Windows Form Designer generated code
		   		   		   		   		   void InitializeComponent(void)
		   {
			   ...
			   this->PerformLayout();
		   		   ...
		   		   void loadUserCards() {
			   userCardsPanel->Controls->Clear(); 			   int yPosition = 10; 
			   Vertex<User*>* user = this->network->getFirstUser();
				   ...
				   userCardPanel->Width = 1000;  				   userCardPanel->Height = 120; 				   userCardPanel->Location = System::Drawing::Point(10, yPosition);  				   userCardPanel->BackColor = Color::White; 				   userCardPanel->Padding = System::Windows::Forms::Padding(5); 
				   				   Label^ usernameLabel = gcnew Label();
				   usernameLabel->Text = "Username: " + gcnew String(user->value->getUsername().c_str());
				   usernameLabel->Font = gcnew System::Drawing::Font("Calibri", 10, FontStyle::Bold); 				   usernameLabel->Location = System::Drawing::Point(10, 10); 				   usernameLabel->AutoSize = true;
				   

				   Label^ cityLabel = gcnew Label();
				   cityLabel->Text = "City: " + gcnew String(user->value->getCity().c_str());
				   cityLabel->Font = gcnew System::Drawing::Font("Calibri", 10); 				   cityLabel->Location = System::Drawing::Point(10, 30); 				   cityLabel->AutoSize = true;
				   

				   Label^ lastLoginLabel = gcnew Label();
				   lastLoginLabel->Text = "Last Login: " + gcnew String(user->value->getLastLogin().c_str());
				   lastLoginLabel->Font = gcnew System::Drawing::Font("Calibri", 10); 				   lastLoginLabel->Location = System::Drawing::Point(10, 50); 				   lastLoginLabel->AutoSize = true;
					   ...
					   recentPostLabel->Font = gcnew System::Drawing::Font("Calibri", 8); 					   recentPostLabel->Location = System::Drawing::Point(10, 70);
				   }
				   ...
				   friendRequestButton->Location = System::Drawing::Point(userCardPanel->Width - 200, 10); 				   friendRequestButton->Tag = gcnew String(user->value->getUsername().c_str());					   friendRequestButton->Click += gcnew EventHandler(this, &Search::FriendRequestButton_Click); 
				   				   Button^ followButton = gcnew Button();
				   followButton->Text = "Follow";
				   followButton->Width = 120;
				   followButton->Height = 30;
				   followButton->Location = System::Drawing::Point(userCardPanel->Width - 200, 50); 				   followButton->Tag = gcnew String(user->value->getUsername().c_str()); 				   followButton->Click += gcnew EventHandler(this, &Search::FollowButton_Click); 
				   ...
				   userCardPanel->Controls->Add(followButton);
				   				   ...
				   				   yPosition += userCardPanel->Height + 15; 				   user = user->nextVertex;
			   }
